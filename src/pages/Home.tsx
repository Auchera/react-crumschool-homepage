...
const cards = [
    ...
    { title: "Özel Yetenek Testi 3", subtitle: "6. Sınıf", image: "/images/course3.jpg" },
    { title: "Özel Yetenek Testi 4", subtitle: "5. Sınıf", image: "/images/course4.jpg" },
            ...
            <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
                <div className="max-w-6xl mx-auto flex justify-between items-center py-4 px-6 relative">
                    ...
                    <div className="absolute left-1/2 transform -translate-x-1/2">
                        <span  className="text-xl font-bold text-gray-800 ">AKEM - AKADEMİK KARİYER EĞİTİM MERKEZİ</span>
                    </div>
                    <div className="flex items-center space-x-4">
                       
                        <button className="border border-orange-500 px-4 py-2 text-orange-600 rounded transition-all duration-300 ease-out hover:bg-gray-200 hover:text-orange-600 transform hover:scale-105 active:scale-95">Giriş Yap</button>

                        <button className="border border-orange-500 px-4 py-2 text-white bg-orange-600 rounded transition-all duration-300 ease-out hover:bg-orange-700 transform hover:scale-105 active:scale-95">Kayıt Ol</button>
...
>
<h2 className="text-5xl font-bold text-center text-orange-500 mb-6" style={{ textShadow: '2px 2px 4px black' }}>
    POPÜLER TESTLERİMİZ
</h2>
...
>
    <span className="text-3xl">{"‹"}</span> 
        ...
        <div className="relative w-full overflow-hidden">
                ...
                {cards.map((card, index) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 w-full bg-gray-900 bg-opacity-90 py-4 text-center">
                            ...
                            <p className="text-lg font-bold text-orange-500">{card.subtitle}</p>
                        </div>
                    </div>
                </SwiperSlide> 
         ...
         {/* ------------------ Right Button ------------------*/}
        <button
    className="absolute right-[-60px] top-1/2 -translate-y-1/2 bg-orange-500 text-white w-12 h-12 rounded-full shadow-lg z-50 hover:bg-orange-700 transition flex items-center justify-center"
...
>
    ...
    <div className="mt-8">
    <button
        className="relative border border-white bg-gray-900 text-white font-bold py-3 px-8 rounded-lg shadow-lg uppercase tracking-wide overflow-hidden group"
    >
        ...
        <span className="relative z-10">Tüm Testleri Görüntüle</span>
    </button>
</div>
...
>
    ...
    <div className="relative z-10 text-center mb-12">
        ...
        <h2 className="mt-6 text-4xl font-bold text-white" style={{ textShadow: '2px 2px 4px black' }} >
...
>
    <div className="max-w-6xl mx-auto grid grid-cols-4 gap-6">
        ...
        <div>
            <h3 className="font-bold mb-3 text-orange-500">Kurumsal</h3>
            <p>Hakkımızda</p>
            <p>SSS</p>
            <p>İletişim</p>
        </div>
        <div>
            <h3 className="font-bold mb-3 text-orange-500">Programlar</h3>
            <p>Eğitimler</p>
            <p>Eğitmenler</p>
        </div>
        <div>
            <h3 className="font-bold mb-3 text-orange-500">Diğer</h3>
            <p>Makaleler</p>
